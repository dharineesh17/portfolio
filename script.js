...
const portfolioData = {
    ...
    websites: [
        { id: 1, title: 'Resume Website', description: 'A modern, responsive resume website showcasing my projects, skills, and experiences. Designed to deliver a seamless user experience across devices with clean layout and interactive features.', tech: 'HTML5, CSS3, JavaScript', image: './assets/sites/resume.png', link: 'https://dharineesh17.github.io/resume/', linkText: 'Visit Site' },
        { id: 2, title: 'Restaurant Website', description: 'A modern and responsive restaurant website designed to showcase the menu, share the story behind the restaurant, and provide an enquiry form. It features a clean layout, engaging visuals, and a user-friendly experience across all devices.', tech: 'HTML5, CSS3, JavaScript, Bootstrap', image: './assets/sites/restaurant1.png', link: 'https://dharineesh17.github.io/srirangaatiffenstall/', linkText: 'Visit Site' },
        { id: 3, title: 'TrichyMango.in', description: 'A responsive and modern promotional website that highlights seasonal mango varieties and pricing. Designed to provide a clear, bilingual, and mobile-friendly shopping experience with easy contact options.', tech: 'HTML5, CSS3, JavaScript', image: './assets/sites/trichyMango.png', link: 'https://dharineesh17.github.io/trichymango.in/', linkText: 'Visit Site' },
        { id: 4, title: 'Jeev FaceWash Cream', description: 'A responsive and modern product landing website for showcasing a homemade natural face wash cream. Designed to engage users with smooth animations, product highlights, and mobile-friendly UI.', tech: 'HTML5, CSS3, JavaScript, TailwindCSS', image: './assets/sites/jeev.png', link: 'https://dharineesh17.github.io/jeevfacewashcream/', linkText: 'Visit Site' },
