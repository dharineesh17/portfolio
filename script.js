...
const portfolioData = {
    products: [
        ...
        { id: 2, title: 'DoPomodoro', description: 'A responsive Pomodoro timer web app to boost productivity through structured focus and break sessions.', tech: 'HTML5, CSS3, JavaScript', image: './assets/products/dopomodoro.png', link: 'https://dharineesh17.github.io/dopomodoro/', linkText: 'Try' },
        { id: 3, title: 'QB Code', description: 'A web app to generate customizable QR codes and barcodes with color, logo, and format options.', tech: 'HTML5, CSS3, JavaScript, QRCode.js, JsBarcode, Html5-QRCode.', image: './assets/products/qbcode.png', link: 'https://dharineesh17.github.io/qbcode/', linkText: 'Try' },
        { id: 4, title: 'Monochrome Magic', description: 'A responsive web app that converts images into stunning black & white art with 15+ creative monochrome filters.', tech: 'HTML5, CSS3, JavaScript', image: './assets/products/monochromeMagic.png', link: 'https://dharineesh17.github.io/monochromemagic/', linkText: 'Try' },
        { id: 5, title: 'AgeVerse', description: 'A visually engaging web app that tracks your age, milestones, and life stats in real time — including birthdays, heartbeats, fun conversions, and progress charts. All data is processed locally for complete privacy.', tech: 'HTML, Tailwind CSS, JavaScript', image: './assets/products/ageverse.png', link: 'https://dharineesh17.github.io/ageverse/', linkText: 'Try' },
        { id: 6, title: 'TaskMate', description: 'A responsive, dark-themed to-do list app for managing tasks with titles, descriptions, timestamps, and local storage — all in a sleek, mobile-friendly interface.', tech: 'HTML, Tailwind CSS, JavaScript', image: './assets/products/taskMate.png', link: 'https://dharineesh17.github.io/taskmate/', linkText: 'Try' },
        { id: 7, title: 'Easy Quotation', description: 'A responsive web app to generate simple billing quotations with tax, and export options in PNG or PDF format.', tech: 'HTML, Tailwind CSS, JavaScript', image: './assets/products/easyQuotation.png', link: 'https://dharineesh17.github.io/EasyQuotation/', linkText: 'Try' },
    ],
    games: [
    ...
    websites: [
        { id: 1, title: 'Portfolio Website', description: 'Developed a responsive personal portfolio web application with a sleek dark theme, engaging animations, and a custom splash screen, designed to showcase projects and skills.', tech: 'HTML5, CSS3, JavaScript, TailwindCSS', image: './assets/sites/portfolio.png', link: 'https://dharineesh17.github.io/porfolio/', linkText: 'Visit Site' },
        { id: 2, title: 'Resume Website', description: 'A modern, responsive resume website showcasing my projects, skills, and experiences. Designed to deliver a seamless user experience across devices with clean layout and interactive features.', tech: 'HTML5, CSS3, JavaScript', image: './assets/sites/resume.png', link: 'https://dharineesh17.github.io/resume/', linkText: 'Visit Site' },
        { id: 3, title: 'Restaurant Website', description: 'A modern and responsive restaurant website designed to showcase the menu, share the story behind the restaurant, and provide an enquiry form. It features a clean layout, engaging visuals, and a user-friendly experience across all devices.', tech: 'HTML5, CSS3, JavaScript, Bootstrap', image: './assets/sites/restaurant1.png', link: 'https://dharineesh17.github.io/srirangaatiffenstall/', linkText: 'Visit Site' },
        { id: 4, title: 'TrichyMango.in', description: 'A responsive and modern promotional website that highlights seasonal mango varieties and pricing. Designed to provide a clear, bilingual, and mobile-friendly shopping experience with easy contact options.', tech: 'HTML5, CSS3, JavaScript', image: './assets/sites/trichyMango.png', link: 'https://dharineesh17.github.io/trichymango.in/', linkText: 'Visit Site' },
        { id: 5, title: 'Jeev FaceWash Cream', description: 'A responsive and modern product landing website for showcasing a homemade natural face wash cream. Designed to engage users with smooth animations, product highlights, and mobile-friendly UI.', tech: 'HTML5, CSS3, JavaScript, TailwindCSS', image: './assets/sites/jeev.png', link: 'https://dharineesh17.github.io/jeevfacewashcream/', linkText: 'Visit Site' },
